...
class AnimalSoftDeleteTest extends KernelTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->animalSoftDelete = new AnimalSoftDelete($this->animalRepository);
    ...
    public function test__invoke()
    {
        ...
        $this->animalRepository->expects($this->once())
            ->method('save')
            ->with($animal);
        $this->animalSoftDelete->__invoke($animal->getId());
    ...
    public function test__invokeThrowsModelNotFound()
    {
        ...
        $this->animalSoftDelete->__invoke('non-existing-id');
    }
}
