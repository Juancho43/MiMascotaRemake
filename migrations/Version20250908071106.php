 ...
 */
final class Version20250908071106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entries (id VARCHAR(36) NOT NULL, journal_id VARCHAR(36) NOT NULL, title VARCHAR(60) NOT NULL, content LONGTEXT NOT NULL, date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', createdAt DATETIME DEFAULT NULL, updatedAt DATETIME DEFAULT NULL, deletedAt DATETIME DEFAULT NULL, INDEX IDX_2DF8B3C5478E8802 (journal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE forums (id VARCHAR(36) NOT NULL, name VARCHAR(60) NOT NULL, slug VARCHAR(60) NOT NULL, description VARCHAR(200) NOT NULL, createdAt DATETIME DEFAULT NULL, updatedAt DATETIME DEFAULT NULL, deletedAt DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE journals (id VARCHAR(36) NOT NULL, user_id VARCHAR(36) DEFAULT NULL, slug VARCHAR(255) NOT NULL, createdAt DATETIME DEFAULT NULL, updatedAt DATETIME DEFAULT NULL, deletedAt DATETIME DEFAULT NULL, INDEX IDX_13A255C1A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE locations (id VARCHAR(36) NOT NULL, city VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, latitude VARCHAR(8) NOT NULL, longitude VARCHAR(8) NOT NULL, slug VARCHAR(255) NOT NULL, createdAt DATETIME DEFAULT NULL, updatedAt DATETIME DEFAULT NULL, deletedAt DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE posts (id VARCHAR(36) NOT NULL, forum_id VARCHAR(36) DEFAULT NULL, user_id VARCHAR(36) DEFAULT NULL, animal_id VARCHAR(36) DEFAULT NULL, location_id VARCHAR(36) DEFAULT NULL, title VARCHAR(100) NOT NULL, slug VARCHAR(100) NOT NULL, content VARCHAR(200) NOT NULL, reportedAt DATETIME DEFAULT NULL, createdAt DATETIME DEFAULT NULL, updatedAt DATETIME DEFAULT NULL, deletedAt DATETIME DEFAULT NULL, INDEX IDX_885DBAFA29CCBAD0 (forum_id), INDEX IDX_885DBAFAA76ED395 (user_id), INDEX IDX_885DBAFA8E962C16 (animal_id), INDEX IDX_885DBAFA64D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id VARCHAR(36) NOT NULL, name VARCHAR(50) NOT NULL, role VARCHAR(50) NOT NULL, telephone VARCHAR(25) NOT NULL, email VARCHAR(100) NOT NULL, code VARCHAR(6) NOT NULL, is_verified TINYINT(1) NOT NULL, password VARCHAR(255) NOT NULL, createdAt DATETIME DEFAULT NULL, updatedAt DATETIME DEFAULT NULL, deletedAt DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
