 ...
 */
final class Version20250713130839 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD user_id VARCHAR(36) DEFAULT NULL');
        $this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E9A76ED395 FOREIGN KEY (user_id) REFERENCES user_image (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE user_image ADD CONSTRAINT FK_27FFFF07BF396750 FOREIGN KEY (id) REFERENCES users (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
    }
}
