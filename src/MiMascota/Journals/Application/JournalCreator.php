...
final readonly class JournalCreator
{
    ...
    {}
    public function __invoke(User $user,string $name, string $breed, \DateTimeImmutable $age, string $gender, string $weight, string $size,string $color, string $description): Journal
    {
